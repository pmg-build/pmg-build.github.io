# What Preet does next

Short checklist only Preet can finish in GitHub / hosting settings.

1. **GitHub repo About**  
   On https://github.com/pmg-build/pmg-build.github.io click the gear next to **About**.  
   - Description: `Portfolio — Preet Desai, CMU Heinz MSISPM. Cyber, risk, GRC. Summer 2027.`  
   - Website: `https://preet-desai.me`  
   Git cannot set this field.
